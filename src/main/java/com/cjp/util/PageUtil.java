...
public class PageUtil {
     ...
     * 翻页方法
     */
    public static String genPagination(String targetUrl,int currentPage,
                                       long totalNum,int pageSize,String param){
       //总共页数
        if(totalNum==0){
            return "未查询到数据";
        }
        ...
        if(currentPage>1){  //当前页不是第一页，显示上一页
            ...
            pageCode.append("<li class='disabbled'><a href='#'>上一页</a></li>");
